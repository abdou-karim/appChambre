 ...
 */
final class Version20201122114909 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chambre (id INT AUTO_INCREMENT NOT NULL, id_batiment_id INT NOT NULL, id_type_chambre_id INT NOT NULL, numero VARCHAR(255) NOT NULL, statut TINYINT(1) NOT NULL, INDEX IDX_C509E4FFCEE444EC (id_batiment_id), INDEX IDX_C509E4FF6F4A6AF9 (id_type_chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, id_type_bourse_id INT DEFAULT NULL, numero_chambre_id INT DEFAULT NULL, matricule VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, date_naissance DATE NOT NULL, statut TINYINT(1) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, inshoused TINYINT(1) DEFAULT NULL, INDEX IDX_717E22E3C7C721C7 (id_type_bourse_id), INDEX IDX_717E22E3FBEAE2F7 (numero_chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
