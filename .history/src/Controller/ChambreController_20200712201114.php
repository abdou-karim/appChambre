...
class ChambreController extends AbstractController
{
 ...
 /**
    ...
    {
        $chambre = $this->getDoctrine()->getRepository(Chambre::class)->findBy(['statut' => '1']);
     ...
     * @Route("/listechambre", options={"expose"=true}, name="deletechambre")
     */
    public function allListChambre(ChambreRepository $chambreRepository, Request $request)
    {
       if($request->isXmlHttpRequest()){
        ...
        $chambre = $entityManager->getRepository(Chambre::class)->find( $iddelete);
 ...
 /**
    ...
    {
        $chambres = $this->getDoctrine()->getRepository(Chambre::class)->findBy(['id'=>"$id,'statut' => '1']);
