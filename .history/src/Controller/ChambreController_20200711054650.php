  ...
  /**
...

    {
        ...
        if($request->isXmlHttpRequest())
        {
            ...
            $idbatiment = $request->request->get('batiment');
            $idbatiment = $request->request->get('batiment');
            $typach = $request->request->get('type');
            $statut=0;
           $chambre->setStatut($statut);
           $chambre->setIdBatiment($idbatiment);
           $chambre->setIdTypeChambre($typach);
