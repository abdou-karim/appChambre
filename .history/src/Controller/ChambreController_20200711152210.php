...
class ChambreController extends AbstractController
{
 ...
 /**
  ...
  /**
     ...
     *@Route("/chambre/deltechambre",options={"expose"=true}, name="supprimechambre")
     */
...

    {
        ...
        if($request->isXmlHttpRequest())
        {
            ...
            $em= $this->getDoctrine()->getManager();
             $emm = $em->getRepository('AppBundle:Chambre')->find($iddelete);
            $em->remove($emm);
            $em->flush();
            $this->addslashes('message','delete successfully');
